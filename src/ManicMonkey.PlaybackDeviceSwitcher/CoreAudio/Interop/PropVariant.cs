...
namespace ManicMonkey.CoreAudio.Interop
{
    ...
    /// Taken from: http://blogs.msdn.com/b/adamroot/archive/2008/04/11/interop-with-propvariants-in-net.aspx    
    /// </summary>
    /// <remarks>
    ...
    internal struct PropVariant
    {
        ...
        private byte[] GetDataBytes()
        {
            ...
            if (IntPtr.Size == 4) BitConverter.GetBytes(p.ToInt32()).CopyTo(ret, 0);
            else if (IntPtr.Size == 8) BitConverter.GetBytes(p.ToInt64()).CopyTo(ret, 0);
